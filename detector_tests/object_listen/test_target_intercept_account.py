...
def send_account_listen_data(session, detector_id, alarm_id):
    headers = {
    ...
    account_data = {
        ...
        "receiver": "abc2@sina.com,abc3@sina.com",
        "cc": "abc4@sina.com,abc5@sina.com,abc6@sina.com",
        "bcc": "abc7@sina.com",
        "subject": "Test",
        "mail_content": "This is a test",
        "attachment": ["附件1.txt", "附件2.doc", "附件3.pdf"]
    }
    data = []
    data.append(account_data)

    send_url = ROOT_URL + "V1/object_listen/account_listen/center_policy"
    print send_url
...
def send_account_listen_file(session, detector_id, alarm_id, num):
    file_name = str(int(time.time())) + '_002_' + str(num) + '.pcap'
    file_path = TEST_PATH + 'intercept_account/' + detector_id + '/'
    ...
    send_url = ROOT_URL + "V1/object_listen/account_listen/center_policy_pcap"
    print send_url
...
if __name__ == '__main__':
    ...
    n = 1
    s = requests.Session()
    send_account_listen_data(s, device_id, a_id)
    send_account_listen_file(s, device_id, a_id, n)
