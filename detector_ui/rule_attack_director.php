    ...
    <div>
        ...
        <div class="row">
            <div class="upper-btn-group margin_ddos1 pull-left">
                <button resourceid="359" id="" type="button" class="btn btn-primary nav-btn" onClick="location='rule_trojan_director.php'"><i class="fa fa-certificate">&nbsp;&nbsp;</i>木马攻击检测策略</button>
                <button resourceid="361" id="" type="button" class="btn btn-primary nav_interval nav-btn active" onClick="location='rule_attack_director.php'"><i class="fa fa-bug">&nbsp;&nbsp;</i>漏洞利用检测策略</button>
...
//            row.find("td:eq(11)").html(task_group_dom);
            row.find("td:eq(10)").html(msgListObj[i].task_id != 0 ? msgListObj[i].task_id : '');
            row.show();
