...
<!--            </div>-->
            <div class="upper-btn-group margin_ddos1 pull-left">
                ...
                <button resourceid='381' id="" type="button" class="btn btn-primary nav_interval nav-btn active"  onClick="location='rule_account_listen.php'"><i class="fa fa-file">&nbsp;&nbsp;</i>账号审计检测策略</button>
            </div>
