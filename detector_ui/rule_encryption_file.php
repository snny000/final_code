...
<!--            </div>-->
            <div class="upper-btn-group margin_ddos1 pull-left">
                ...
                <button resourceid="369" id="" type="button" class="btn btn-primary nav_interval nav-btn active" onClick="location='rule_encryption_file.php'"><i class="fa fa-lock">&nbsp;&nbsp;</i>加密文件检测策略</button>
