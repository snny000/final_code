...
<!--            </div>-->
            <div class="upper-btn-group margin_ddos1 pull-left">
                <button resourceid='375' id="" type="button" class="btn btn-primary nav-btn active" onClick="location='rule_ip_listen_director.php'"><i class="fa fa-television">&nbsp;&nbsp;</i>IP审计检测策略</button>
...
//            row.find("td:eq(13)").html(task_group_dom);
            row.find("td:eq(12)").html(msgListObj[i].task_id != 0 ? msgListObj[i].task_id : '');
            row.show();
