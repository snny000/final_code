...
<div id="whole-wrapper">
    ...
    <div>
        <div class="row nav_margin">
            <div class="pull-left">
                <h4><span class="tab_color">|</span>&nbsp;&nbsp;URL审计检测策略
...
<!--                <h4><span class="tab_color">|</span>&nbsp;&nbsp;URL审计检测策略</h4>-->
<!--            </div>-->
            <div class="upper-btn-group margin_ddos1 pull-left">
                ...
                <button resourceid='379' id="" type="button" class="btn btn-primary nav_interval nav-btn active"  onClick="location='rule_url_listen_director.php'"><i class="fa fa-link">&nbsp;&nbsp;</i>URL审计检测策略</button>
