...
<div id="whole-wrapper">
    ...
    <div>
        <div class="row nav_margin">
            <div class="pull-left">
                <h4><span class="tab_color">|</span>&nbsp;&nbsp;域名审计检测策略
...
<!--                <h4><span class="tab_color">|</span>&nbsp;&nbsp;域名审计检测策略</h4>-->
<!--            </div>-->
            <div class="upper-btn-group margin_ddos1 pull-left">
                ...
                <button resourceid='377' id="" type="button" class="btn btn-primary nav_interval nav-btn active" onClick="location='rule_domain_listen_director.php'"><i class="fa fa-wikipedia-w">&nbsp;&nbsp;</i>域名审计检测策略</button>
                ...
                <button resourceid='381' id="" type="button" class="btn btn-primary nav_interval nav-btn"  onClick="location='rule_account_listen_director.php'"><i class="fa fa-file">&nbsp;&nbsp;</i>账号审计检测策略</button>
            </div>
        </div>
        ...
        <div class="row btn-banner">
            ...
            <input id="dns" type="text" class="form-control search-input btn-interval" placeholder="域名信息（模糊搜索）">
		...
		<div class="row btn-banner">
			<div class="dropdown dropdown-inline">
                ...
                <ul class="dropdown-menu dropdown-menu-width dropdown-list-style" id="ipslist">
                   ...
                   <!-- <li onclick="selectProtoFwd(this);" value="1">与表达式</li>-->
    ...
    <div class="modal-dialog" style="width: 390px">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div>
                    <span>域名信息（最大64字节）：</span> <input id="add_dns" maxlength="64" class="form-control";>
                 ...
                 <div class="dropdown-inline">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-width dropdown-list-style" id="ipslist">
                            ...
                            <li onclick="selectProtoFwd(this);" value="0">无表达式</li>
                            <li onclick="selectProtoFwd(this);" value="1">与表达式</li>
                            <li onclick="selectProtoFwd(this);" value="2">正则表达式</li>
                        </ul>
                    </div>
					<div style="color:red"></div>
                </div>
...
$("#add-submit").click(function(){
        ...
        var param = {
            ...
            if(add_dns == ""){
                $("#add_dns").next("div").html("域名信息不能为空")
                ischeck = false
            }else{
    ...
    function List(msgListObj){
		...
		var ruleMap={0:'无表达式',1:'与表达式',2:'正则表达式'}
...
//            row.find("td:eq(11)").html(task_group_dom);
    ...
    $("#searchButton").click(function(){
		...
		if(duration!=""){
            globalSearchParam["duration"] = duration
        }
        if(device_id!=""){
