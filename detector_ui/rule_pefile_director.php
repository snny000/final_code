    ...
    <div>
        ...
        <div class="row">
            <div class="upper-btn-group margin_ddos1 pull-left">
                ...
                <button resourceid="363" id="" type="button" class="btn btn-primary nav_interval nav-btn active" onClick="location='rule_pefile_director.php'"><i class="fa fa-user-secret">&nbsp;&nbsp;</i>恶意程序检测策略</button>
            </div>
        </div>
