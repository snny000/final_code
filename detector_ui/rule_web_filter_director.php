...
<!--                <h4><span class="tab_color">|</span>&nbsp;&nbsp;应用行为WEB过滤策略</h4>-->
<!--            </div>-->
            <div class="upper-btn-group margin_ddos1 pull-left">
                ...
                <button resourceid='387' id="" type="button" class="btn btn-primary nav_interval nav-btn active"  onClick="location='rule_web_filter_director.php'"><i class="fa fa-filter">&nbsp;&nbsp;</i>应用行为WEB过滤策略</button>
                <button resourceid='389' id="" type="button" class="btn btn-primary nav_interval nav-btn"  onClick="location='rule_dns_filter_director.php'"><i class="fa fa-fire">&nbsp;&nbsp;</i>应用行为DNS过滤策略</button>
            </div>
        </div>
        ...
        <div class="row btn-banner">
            ...
            <input id="url" type="text" class="form-control search-input btn-interval" placeholder="URL信息（模糊搜索）">
    ...
    <div class="modal-dialog" style="width: 390px">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div>
                    <span>URl信息（最大128字节）：</span> <input id="add_url" maxlength="128" class="form-control";>
...
$("#add-submit").click(function(){
        ...
        var param = {
            ...
            if(add_url == ""){
                $("#add_url").next("div").html("URL信息不能为空")
                ischeck = false
            }else{
    ...
    function List(msgListObj){
        ...
        for (var i = 0; i < msgListObj.length; i++) {
			...
			row.find("td:eq(2)").html(msgListObj[i].url);
