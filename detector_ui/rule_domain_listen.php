...
<!--            </div>-->
            <div class="upper-btn-group margin_ddos1 pull-left">
                <button resourceid='375' id="" type="button" class="btn btn-primary nav-btn " onClick="location='rule_ip_listen.php'"><i class="fa fa-television">&nbsp;&nbsp;</i>IP审计检测策略</button>
                <button resourceid='377' id="" type="button" class="btn btn-primary nav_interval nav-btn active" onClick="location='rule_domain_listen.php'"><i class="fa fa-wikipedia-w">&nbsp;&nbsp;</i>域名审计检测策略</button>
