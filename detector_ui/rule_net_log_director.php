...
<div id="whole-wrapper">
    ...
    <div>
        <div class="row nav_margin">
            <div class="pull-left">
                <h4><span class="tab_color">|</span>&nbsp;&nbsp;通联关系上报策略
...
<!--                <h4><span class="tab_color">|</span>&nbsp;&nbsp;通联关系上报策略</h4>-->
<!--            </div>-->
            <div class="upper-btn-group margin_ddos1 pull-left">
                <button resourceid='383' id="" type="button" class="btn btn-primary nav-btn active" onClick="location='rule_net_log_director.php'"><i class="fa fa-upload">&nbsp;&nbsp;</i>通联关系上报策略</button>
        ...
        <div class="row btn-banner">
			...
			<input id="num" type="text" class="form-control search-input btn-interval" placeholder="日志条数">
    ...
    <div class="modal-dialog" style="width: 390px">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div>
                     <span>每次上报的时间间隔（数值型，分钟）:</span> <input id="add_interval" type="number" min="0"  class="form-control";>
                    <div style="color:red"></div>
                    <span>日志条数（数值型）:</span> <input id="add_num" type="number" min="0"  class="form-control";>
                    <div style="color:red"></div>
                </div>
                <div>
                    <div> 选择任务组:</div>
...
$("#add-submit").click(function(){
        ...
        var param = {
            ...
            if(add_num == ""){
                $("#add_num").next("div").html("日志条数不能为空")
                ischeck = false
            }else{
