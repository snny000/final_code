...
<div id="whole-wrapper">
    ...
    <div>
        <div class="row nav_margin">
            <div class="pull-left">
                <h4><span class="tab_color">|</span>&nbsp;&nbsp;涉密内容检测策略
...
<!--            </div>-->
            <div class="upper-btn-group margin_ddos1 pull-left">
                <button resourceid="367" id="" type="button" class="btn btn-primary nav-btn active" onClick="location='rule_keyword_file_director.php'"><i class="fa fa-key">&nbsp;&nbsp;</i>关键字检测策略</button>
    ...
    <div class="modal-dialog" style="width: 390px">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div>
                    <span> 最少命中次数（数值型）:</span> <input id="add_min_match_count" type="number" class="form-control" value=1 min="1" max="20">
                    <div style="color:red"></div>
                    <span> 规则内容（最长512，关键词规则为关键词表达式，正则规则为正则表达式）:</span>
                    <textarea id="add_rule_content" style="width:100%;height:80px;resize: vertical;" class="form-control" maxlength="512" placeholder='关键词类型 例："十九大" 例："十九大"&"hello"'></textarea>
                    <div style="color:red"></div>
                </div>
                <div>
                    <div> 选择任务组:</div>
...
<script>
    ...
    $('#addModal h4 i.hint-helper').attr("value", rule_keyword_helper_text);
    ...
    $("#add-submit").click(function(){
            ...
            if(add_rule_content == "") {
                ...
                ischeck = false
            } else if(add_rule_content.toString().indexOf('“') > 0 || add_rule_content.toString().indexOf('”') > 0) {
                $("#add_rule_content").next("div").html("规则内容包含中文引号")
                ischeck = false
            } else if(!(/[^a-zA-Z0-9\u4e00-\u9fa5]+/.test(add_rule_content))) {
                add_rule_content = '"' + add_rule_content + '"'
            }
            else{
