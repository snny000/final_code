...
<!--            </div>-->
            <div class="upper-btn-group margin_ddos1 pull-left">
                <button resourceid='383' id="" type="button" class="btn btn-primary nav-btn " onClick="location='rule_net_log.php'"><i class="fa fa-upload">&nbsp;&nbsp;</i>通联关系上报策略</button>
                <button resourceid='385' id="" type="button" class="btn btn-primary nav_interval nav-btn" onClick="location='rule_app_behavior.php'"><i class="fa fa-cloud-upload">&nbsp;&nbsp;</i>应用行为上报策略</button>
                <button resourceid='387' id="" type="button" class="btn btn-primary nav_interval nav-btn"  onClick="location='rule_web_filter.php'"><i class="fa fa-filter">&nbsp;&nbsp;</i>应用行为WEB过滤策略</button>
                <button resourceid='389' id="" type="button" class="btn btn-primary nav_interval nav-btn active"  onClick="location='rule_dns_filter.php'"><i class="fa fa-fire">&nbsp;&nbsp;</i>应用行为DNS过滤策略</button>
            </div>
