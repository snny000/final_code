...
<!--            </div>-->
            <div class="upper-btn-group margin_ddos1 pull-left">
                ...
                <button resourceid='385' id="" type="button" class="btn btn-primary nav_interval nav-btn active" onClick="location='rule_app_behavior.php'"><i class="fa fa-cloud-upload">&nbsp;&nbsp;</i>应用行为上报策略</button>
