            ...
            <div class="pull-left margin_ddos1">
                <h4><span class="tab_color">|</span>&nbsp;&nbsp;插件任务
                    <div class="btn-group" data-toggle="buttons">
                        <button type="button" href='plug_task.php' class="btn btn-default">管理中心本地</button>
                        <button type="button" href='plug_task_director.php' class="btn btn-default btn-primary">指挥节点下发</button>
                    </div>
                </h4>
            </div>
        </div>
...
//            row.find("td:eq(10)").html(formatterOperate(msgListObj[i]));
            row.find("td:eq(10)").html(msgListObj[i].config);
//            row.find("td:eq(10)").html(JSON.stringify(JSON.parse(msgListObj[i].config)));
