...
<!--            </div>-->
            <div class="upper-btn-group margin_ddos1 pull-left">
                ...
                <button resourceid="371" id="" type="button" class="btn btn-primary nav_interval nav-btn active"  onClick="location='rule_compress_file_director.php'"><i class="fa fa-compress">&nbsp;&nbsp;</i>多层压缩检测策略</button>
