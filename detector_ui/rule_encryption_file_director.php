...
<div id="whole-wrapper">
    ...
    <div>
        <div class="row nav_margin">
            <div class="pull-left">
                <h4><span class="tab_color">|</span>&nbsp;&nbsp;加密文件检测策略
...
<!--                <h4><span class="tab_color">|</span>&nbsp;&nbsp;加密文件检测策略</h4>-->
<!--            </div>-->
            <div class="upper-btn-group margin_ddos1 pull-left">
                ...
                <button resourceid="369" id="" type="button" class="btn btn-primary nav_interval nav-btn active" onClick="location='rule_encryption_file_director.php'"><i class="fa fa-lock">&nbsp;&nbsp;</i>加密文件检测策略</button>
                ...
                <button resourceid="373" id="" type="button" class="btn btn-primary nav_interval nav-btn"  onClick="location='rule_picture_file_director.php'"><i class="fa fa-file-image-o">&nbsp;&nbsp;</i>图片筛选策略</button>
            </div>
        </div>
        ...
        <div class="row btn-banner">
            ...
            <input id="filesize_minsize" type="text" class="form-control search-input btn-interval" placeholder="文件最小值">
			<input id="filesize_maxsize" type="text" class="form-control search-input btn-interval" placeholder="文件最大值">
        ...
        <div class="row common_margin">
            <table id="maintable" class="table table-hover tbl_font_size "
                ...
                <tr >
                    ...
                    <th width="11%">规则编号</th>
                    <th width="11%">文件最小值</th>
                    <th width="11%">文件最大值</th>
                    <th width="11%">规则状态</th>
                    <th width="9%">告警级别</th>
					<th width="9%">标签</th>
                    <th width="9%">创建时间</th>
    ...
    <div class="modal-dialog" style="width: 390px">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div>
                     <span>文件最小值（数值型，KB）:</span> <input id="add_filesize_minsize" type="number" min="0" class="form-control";>
                    <div style="color:red"></div>
                    <span>文件最大值（数值型，KB）:</span> <input id="add_filesize_maxsize" type="number" min="0"  class="form-control";>
                    <div style="color:red"></div>
                </div>
...
<script>
    ...
    var global_policy_type=6;


    // 设置规则提示
    $('#addModal h4').html('添加策略' + helper_ele);
    $('#addModal h4 i.hint-helper').attr("value", rule_encryption_helper_text);
...
$("#add-submit").click(function(){
        ...
        var param = {
            ...
            if(add_filesize_minsize == ""){
                $("#add_filesize_minsize").next("div").html("文件最小值不能为空")
                ischeck = false
            }else{
            ...
            if(add_filesize_maxsize == ""){
                $("#add_filesize_maxsize").next("div").html("文件最大值不能为空")
                ischeck = false
            }else{
