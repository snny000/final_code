...
<!--            </div>-->
            <div class="upper-btn-group margin_ddos1 pull-left">
                ...
                <button resourceid='379' id="" type="button" class="btn btn-primary nav_interval nav-btn active"  onClick="location='rule_url_listen.php'"><i class="fa fa-link">&nbsp;&nbsp;</i>URL审计检测策略</button>
