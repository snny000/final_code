...
# 发送文件至业务系统
def send_business_file(logger_str, flag, device_id, header, file_path, filename, url=BUSINESS_URL):
...
# 发送数据至业务系统
def send_business_data(logger_str, flag, device_id, send_data, url=BUSINESS_URL):
    ...
    try:
        ...
        for d in send_data:
            ...
            print 'Authorization Key:', send_header['Authorization']
...
def async_send_business_file(logger_str, flag, device_id, header, file_path, filename, url=BUSINESS_URL):
...
def async_send_business_data(logger_str, flag, device_id, send_data, url=BUSINESS_URL):
